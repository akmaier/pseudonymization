...
# The author block.
#
# AUTHORS.md is the source and the order is settled: AM first and Siming Bayer last
# (AM, 2026-09-06), Monica Hinrichs-Mayer second (AM, 2026-09-23), Weber, Lackner, May, Kainz in
# positions 3-6 (AM, 2026-09-26).
#
...
# ---------------------------------------------------------------------------------------------
AUTHOR_BLOCK = r'''% Author order per AUTHORS.md; settled AM 2026-09-06 / 09-23 / 09-26.
\author{%
...
--- Licence -------------------------------------------------------------------
CC BY 4.0 (AM, 2026-09-26). Select it on the form; it cannot be changed after
announcement.

--- Before you upload ---------------------------------------------------------
1. Everyone on the author list has to be told before the paper is posted
   (AUTHORS.md).
2. ACCV's preprint policy for the TrustFMI workshop: posting a non-anonymous
