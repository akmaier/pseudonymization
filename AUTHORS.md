...
Order set by AM, 2026-09-06: **AM first, Siming Bayer last.** The middle four are not yet ordered.
...
**Siming Bayer's affiliation is FAU for this paper** (AM, 2026-09-06), not Siemens Healthineers —
she holds both roles and the FAU one applies here.
...
- **The other Bernhard.** The thread refers to *"Bernhards Tool"* for report de-identification, with
  ...
  is no longer used here. He is therefore not on this list. If that is wrong, he needs adding *and*
  telling.
- The middle order (positions 2–5) still has to be settled, normally by contribution.
- Anyone added must be told before submission.
