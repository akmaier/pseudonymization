...
| **CARDIO:DE** | de | ✅ **granted 2026-09-08 — AM only**, one agreement per person | `10.1038/s41597-023-02128-9`. **500** German cardiology routine doctor's letters, Heidelberg. Two-pass de-identification, PHI → semantic placeholders, date shifting, age shifted by random > 300, lab-value outliers removed by z-score. *Paper read.* One of only two distributable German clinical corpora |
